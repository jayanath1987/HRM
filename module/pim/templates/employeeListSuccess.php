    ...
    <div class="maincontent">
        ...
        ?>><?php echo __("Division") ?></option>
                ...
                <input type="reset" class="plainbtn" id="btnReset"
                       value="<?php echo __("Reset") ?>" /> <input id="show" type="button" class="plainbtn"  value="<?php echo __("Advanced") ?>" />
                <br class="clear"/>
                
                
                <br class="clear"/>
                <div id="advsrc"  >
                    <label for="cmbSearchMode"><?php echo __("Designation") ?></label>
                    <select name="cmbDesignation" id="cmbDesignation" style="width: 150px;">
                    <option value="all"><?php echo __("--Select--") ?></option>
        ...
        ?>><?php echo $Designation->name ?></option>
                    ...
                    <label for="cmbSearchMode"><?php echo __("Division") ?></label>
                    <select name="cmbDivision" id="cmbDivision" style="width: 150px;">
                    <option value="all"><?php echo __("--Select--") ?></option>
                    <?php foreach ($WorkstationList as $Works){ ?> 
                    <option value="<?php echo $Works->id ?>" <?php
                if ($searchDiv == 'wid') {
                        echo "selected";
                }
        ?>><?php echo $Works->title ?></option>
                    <?php } ?>
                    </select>
                </div>
 ...
 function showPage(page){  
     ...
     //pager.showPage(10);
        ...
        childdiv="";
            ...
            data: { datapage: (page1) , searchmode: $('#cmbSearchMode').val() , searchvalue: $('#txtSearchValue').val(), sort:sort, cmbDesignation: $("#cmbDesignation").val(),  cmbDivision : $("#cmbDivision").val() },
            dataType: "json",
...
//         }
        ...
        childdiv="";
            ...
            async:false,
            url: "<?php echo url_for('pim/Jpagination') ?>",
            data: { datapage: (this.currentPage-1) , searchmode: $('#cmbSearchMode').val() , searchvalue: $('#txtSearchValue').val(), sort:sort, cmbDesignation: $("#cmbDesignation").val(),  cmbDivision : $("#cmbDivision").val() },
            dataType: "json",
            success: function(data){
                    var row = 0; 
                    $.each(data, function(key, value) {
